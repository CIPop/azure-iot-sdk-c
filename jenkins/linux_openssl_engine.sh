...
cmake . -Bcmake -Duse_openssl:BOOL=ON -Drun_e2e_tests:BOOL=ON -Drun_e2e_openssl_engine_tests:BOOL=ON
cd cmake
...
softhsm2-util --init-token --slot 1 --label test-token --pin 1234 --so-pin 4321
